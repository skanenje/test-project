...
func (app *TaskApp) handleCreateTask(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(map[string]interface{}{"message": "Task created", "row_id": rowID, "task": task})
}
...
func (app *TaskApp) handleUpdateTask(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(map[string]interface{}{"message": "Task updated", "task": task, "new_id": newID})
}
